...
1. Open `src/Whisparr.sln`
2. Set `Whisparr.Console` as startup project (framework: `net6.0`)
3. Hit F5 to build and run
4. Backend available at `http://localhost:6969`

#### Command Line
```bash
# Build and run
dotnet run --project src/Whisparr.Console

# Or build for production
dotnet publish src/Whisparr.sln -c Release -o _output
```
