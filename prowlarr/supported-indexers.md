...
|:--|:--|:--|:--|:--|:--|:--|:--|:--|
|[Animedia](https://tt.animedia.tv/){#animedia}|Animedia is russian anime voiceover group and eponymous anime tracker.|ru-RU|False|Text Query|Text Query, Season, Episode|Text Query|Not Supported|Not Supported|
|[1337x](https://1337x.to/){#1337x}|1337X is a Public torrent site that offers verified torrent downloads|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[7torrents](https://www.7torrents.cc/){#7torrents}|7torrents is a Public BitTorrent DHT search engine.|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[ACG\.RIP](https://acg.rip/){#acgrip}|ACG\.RIP is a CHINESE Public torrent tracker for the latest anime and Japanese related torrents|zh-CN|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[ACGsou](https://www.36dm.club/){#acgsou}|ACGsou (36DM) is a CHINESE Public torrent tracker for ANIME|zh-CN|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[AnimeClipse](http://www.animeclipse.com/){#animeclipse}|AnimeClipse is a Public site for Hellenic Fansubs Anime.|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[AniRena](https://www.anirena.com/){#anirena}|AniRena is a Public torrent tracker for the latest anime and Japanese related torrents|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[AniSource](https://asnet.pw/){#anisource}|AniSource is a Public site for HD Anime raws.|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[AudioBookBay](http://audiobookbay.fi/){#audiobookbay}|AudioBook Bay (ABB) is a public Torrent Tracker for AUDIOBOOKS|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Badass Torrents](https://badasstorrents.com/){#badasstorrents}|Badass Torrents is a Public torrent site for MOVIES / TV / GENERAL|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[BigFANGroup](https://bigfangroup.org/){#bigfangroup}|BigFANGroup is a RUSSIAN Public Torrent Tracker for MOVIES / TV|ru-RU|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[BitRu](https://bitru.org/){#bitru}|BitRu is a RUSSIAN Public Torrent Tracker for MOVIES / TV / GENERAL|ru-RU|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[BT4G](https://bt4g.org/){#bt4g}|BT4G is a Public metadata crawler for magnets|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[BTDigg](https://btdig.com/){#btdigg}|BTDigg is a Public BitTorrent DHT search engine.|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[BT\.etree](https://bt.etree.org/){#btetree}|BT\.etree is a Public Tracker dedicated to Bootleg FLAC MUSIC|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[BTSOW](https://btsow.rest/){#btsow}|BTSOW is a Public torrent indexer|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
...
|[MoviesDVDR](https://www.moviesdvdr.co/){#moviesdvdr}|MoviesDVDR is a SPANISH Public tracker for MOVIES|es-ES|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
...
|[Torrent Downloads](https://www.torrentdownloads.info/){#torrentdownloads}|Torrent Downloads (TD) is a Public torrent site for all kinds of content|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
...
|[LimeTorrents clone](https://www.limetorrents.to/){#limetorrentsclone}|LimeTorrents clone is a Public LimeTorrents clone for TV / MOVIES / GENERAL|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
...
|[AnimeBytes](https://animebytes.tv/){#animebytes}|AnimeBytes (AB) is the largest private torrent tracker that specialises in anime and anime-related content.|en-US|False|Text Query|Text Query, Season, Episode|Text Query|Text Query|Text Query|
...
|[AsianCinema](https://asiancinema.me/){#asiancinema}|Tracker Movies/TV/Music|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
...
|[CeskeForum](https://t.ceskeforum.com/){#ceskeforum}|CeskeForum is a CZECH Private Torrent Tracker for MOVIES / TV / GENERAL|cs-CZ|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
...
|[Ebooks-Shares](https://ebooks-shares.org/){#ebooks-shares}|Ebooks-Shares is a Private Torrent Tracker for EBOOKS / AUDIOBOOKS|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
...
|[Greek Team](https://www.greek-team.cc/){#greekteam}|Greek Team is a GREEK Private site for TV / MOVIES / GENERAL|el-GR|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
...
|[Immortuos](https://immortuos.life/){#immortuos}|Immortuos is a GERMAN Private Tracker for MOVIES / TV|de-DE|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
...
|[NewstudioL](http://newstudio.tv/){#newstudiol}|this is the Newstudio indexer with Login enabled in the config.|ru-RU|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
...
|[RGFootball](http://rgfootball.net/){#rgfootball}|RGFootball is a Russian Sports torrent tracker.|ru-RU|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
...
|[TEKNO3D](https://tracker.tekno3d.com/){#tekno3d}|TEKNO3D is a Private Torrent Tracker for MOVIES / TV|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
...
|[Torrent Surf](https://torrentsurf.net/){#torrentsurf}|Torrent Surf is a Private Torrent Tracker for MOVIES / TV / GENERAL|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
...
|[Zelka\.org](http://zelka.org/){#zelkaorg}|Zelka (Zamunda) is a BULGARIAN Private Torrent Tracker for 0DAY / GENERAL|bg-BG|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
...
|[Marine Tracker](https://seatracker.ru/){#marinetracker}|Marine Tracker is a RUSSIAN Semi-Private Torrent Tracker for MARITIME E-LEARNING|ru-RU|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[MediaMaatjes](https://www.mediamaatjes.org/){#mediamaatjes}|MediaMaatjes is a DUTCH Private Torrent Tracker for MOVIES / TV / GENERAL|nl-NL|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[MeseVilág](https://mese-vilag.net/){#mesevilag}|MeseVilág (Fairytale World) is a Hungarian Private site for fairy tales, family movies and comedies|hu-HU|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[MIRCrew](https://mircrew-releases.org/){#mircrew}|MIRCrew is an ITALIAN Private Torrent Tracker for MOVIES / TV / MUSIC|it-IT|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Moviesite](http://moviesite.info.hu/){#moviesite}|Moviesite is a HUNGARIAN Semi-Private tracker for MOVIES / TV / GENERAL|hu-HU|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Movie-Torrentz](https://m2g.link/){#movietorrentz}|Movie-Torrentz is a Private Torrent Tracker for MOVIES / TV|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[M-Team - TP](https://kp.m-team.cc/){#mteamtp}|M-Team TP (MTTP) is a CHINESE Private Torrent Tracker for HD MOVIES / TV / XXX|zh-CN|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[MTeamTP2FA](https://kp.m-team.cc/){#mteamtp2fa}|this indexer uses a cookie login for MTeamTP for those that want to use 2FA|zh-CN|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[MVGroup Forum](https://forums.mvgroup.org/){#mvgroupforum}|MVGroup is a Semi-Private site dedicated to UK TV and DOCUMENTARIES. This definition is for the Forum Tracker site.|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[MVGroup Main](https://forums.mvgroup.org/){#mvgroupmain}|MVGroup is a Semi-Private site dedicated to UK TV and DOCUMENTARIES. This definition is for the Main Tracker site.|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[NetHD](https://nethd.org/){#nethd}|NetHD (VietTorrent) is a VIETNAMESE Semi-Private Torrent Tracker for HD MOVIES / TV|vi-VN|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[OpenCD](https://open.cd/){#opencd}|OpenCD is a CHINESE Private Torrent Tracker for MUSIC|zh-CN|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[OshenPT](https://www.oshen.win/){#oshenpt}|OshenPT is a CHINESE Private Torrent Tracker for HD Movies, TV, Music|zh-CN|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Ourbits](https://ourbits.club/){#ourbits}|Ourbits (HDPter) is a CHINESE Private Torrent Tracker for HD MOVIES / TV / GENERAL|zh-CN|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Peeratiko](https://peeratiko.org/){#peeratiko}|Peeratiko is a GREEK Private Torrent Tracker for MOVIES / TV / GENERAL|el-GR|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[PiratBitL](https://pb.wtf/){#piratbitl}|PirateBit is a RUSSIAN Public Torrent Tracker for MOVIES / TV / GENERAL. This supports login.|ru-RU|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[PTerClub](https://pterclub.com/){#pterclub}|PTerClub is a CHINESE Private Torrent Tracker for HD MUSIC VIDEOS, MOVIES, TV & ANIME|zh-CN|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[PTFiles](https://ptfiles.net/){#ptfiles}|PTFiles (PTF) is a Private site for TV / MOVIES / GENERAL|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[PThome](https://www.pthome.net/){#pthome}|PThome is a CHINESE Private Torrent Tracker for 0DAY / GENERAL|zh-CN|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[PTMSG](https://pt.msg.vg/){#ptmsg}|PTMSG is a CHINESE Private Torrent Tracker for HD MOVIES / TV|zh-CN|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[PTSBAO](https://ptsbao.club/){#ptsbao}|PTSBAO is a CHINESE Private Torrent Tracker for HD MOVIES / TV|zh-CN|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[PTTime](https://www.pttime.org/){#pttime}|PTTime is a ratioless CHINESE Private Torrent Tracker for HD MOVIES / TV / GENERAL|zh-CN|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Punk's Horror Tracker](https://punck-tracker.net/){#punkshorror}|Punk's Horror Tracker is a HUNGARIAN Private Tracker for Horror MOVIES / TV|hu-HU|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[PuTao](https://pt.sjtu.edu.cn/){#putao}|葡萄 (PuTao) is a CHINESE Private Torrent Tracker for MOVIES / TV / GENERAL|zh-CN|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[slosoul](https://slosoul.net/){#slosoul}|slosoul is a Slovanian  Private Torrent Tracker for MOVIES / TV / GENERAL|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[SoundPark](https://sound-park.world/){#soundpark}|SoundPark is a Semi-Private  RUSSIAN site for MUSIC compilations and albums|ru-RU|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[SpiderTK](https://spidertk.xyz/){#spidertk}|SpiderTK is a FRENCH Private Torrent Tracker for MOVIES / TV / GENERAL|fr-FR|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[TorrentMasters](https://torrentmasters.info/){#torrentmasters}|TorrentMasters is a HUNGARIAN private tracker for MOVIES / TV / GENERAL|hu-HU|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[TvRoad](https://tvroad.info/){#tvroad}|TvRoad is a FRENCH Private Torrent Tracker for TV|fr-FR|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[ZOMB](http://zombtracker.the-zomb.com/){#zomb}|ZOMB is a Semi-Private Torrent Tracker for BOOTLEG MUSIC|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Aither (API)](https://aither.cc/){#aither-api}|Aither is a Private Torrent Tracker for HD MOVIES / TV|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[AnimeWorld (API)](https://animeworld.cx/){#animeworld-api}|AnimeWorld (AW) is a GERMAN Private site for ANIME / MANGA / HENTAI|de-DE|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Best-Core](https://best-core.info/){#bestcore}|Best-Core is a HUNGARIAN Private Tracker for MOVIES / TV|hu-HU|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[BitBR](https://bitbr.cc/){#bitbr}|BitBR is a BRAZILIAN Private Torrent Tracker for HD MOVIES / TV|pt-BR|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Bit-City Reloaded](https://bc-reloaded.net/){#bitcityreloaded}|Bit-City Reloaded is a GERMAN Private Torrent Tracker for MOVIES / TV / GENERAL|de-DE|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Blutopia (API)](https://blutopia.xyz/){#blutopia-api}|Blutopia (BLU) is a Private Torrent Tracker for HD MOVIES / TV|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[BrSociety (API)](https://brsociety.club/){#brsociety-api}|BrSociety (SemeandoCC) is a BRAZILIAN Private Torrent Tracker for E-LEARNING|pt-BR|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[BYRBT](https://byr.pt/){#byrbt}|BYRBT is a CHINESE Private Torrent Tracker for HD MOVIES / TV / GENERAL|zh-CN|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[DataScene (API)](https://datascene.xyz/){#datascene-api}|DataScene (DS) is a ROMANIAN Private Torrent Tracker for MOVIES / TV / GENERAL|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[DesiTorrents (API)](https://desitorrents.tv/){#desitorrents-api}|Desitorrents is a Private Torrent Tracker for BOLLYWOOD / TOLLYWOOD / MUSIC|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[DigitalCore](https://digitalcore.club/){#digitalcore}|DigitalCore is a Private Torrent Tracker for MOVIES / TV / GENERAL|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Fuzer](https://www.fuzer.me/){#fuzer}|Another Hebrew tracker|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[hawke-uno](https://www.hawke.uno/){#hawke-uno}|hawke-uno is a Private Torrent Tracker for (X265 / HEVC) MOVIES / TV|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[HD-Olimpo (API)](https://hd-olimpo.club/){#hdolimpo-api}|HD-Olimpo is a SPANISH site for HD content|es-ES|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Hebits](https://hebits.net/){#hebits}|The Israeli Tracker|he-IL|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Il Corsaro Verde](https://www.icv-crew.com/){#ilcorsaroverde}|Il Corsaro Verde (iCV-CreW) is a ratioless ITALIAN Private Torrent Tracker for MOVIES / TV / GENERAL|it-IT|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[MegamixTracker](https://megamixtracker.hu/){#megamixtracker}|MegamixTracker is a HUNGARIAN Private Tracker for MOVIES / TV|hu-HU|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Milkie](https://milkie.cc/){#milkie}|Milkie\.cc (ME) is private torrent tracker for 0day / general|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[ReelFLiX (API)](https://reelflix.xyz/){#reelflix-api}|ReelFLiX (HD4Free,LegacyHD) is a Private Torrent Tracker for HD MOVIES|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Shareisland (API)](https://shareisland.org/){#shareisland-api}|A general italian tracker|it-IT|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[SkipTheCommercials (API)](https://skipthecommericals.xyz/){#skipthecommercials-api}|SkipTheCommercials (STC) is a Private Torrent Tracker for TV|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Superbits](https://superbits.org/){#superbits}|Superbits is a SWEDISH Private Torrent Tracker for MOVIES / TV / GENERAL|sv-SW|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[TellyTorrent (API)](https://telly.wtf/){#tellytorrent-api}|TellyTorrent is an INDIAN Private Tracker for MOVIES / TV|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[TorrentLeech](https://www.torrentleech.org/){#torrentleech}|not here \_ not scene|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[TorrentSeeds (API)](https://torrentseeds.org/){#torrentseeds-api}|TorrentSeeds is a Private Torrent Tracker for MOVIES / TV / MUSIC / GENERAL|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Trackeros (API)](https://trackeros.tk/){#trackeros-api}|Trackeros is a Private SPANISH Tracker for HD MOVIES / TV / GENERAL|es-ES|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[UHD-HEAVEN](https://uhd-heaven.xyz/){#uhd-heaven}|UHD-HEAVEN is a Private Torrent Tracker for UHD MOVIES / TV|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[White Angel](https://white-angel.hu/){#whiteangel}|White Angel is a HUNGARIAN Private Tracker for MOVIES / TV|hu-HU|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[CGPeers](https://cgpeers.to/){#cgpeers}|CGPeers is a Private Torrent Tracker for GRAPHICS SOFTWARE / TUTORIALS / ETC|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[CinemaZ](https://cinemaz.to/){#cinemaz}|CinemaZ (EuTorrents) is a Private Torrent Tracker for FOREIGN NON-ASIAN MOVIES.|en-US|False|Text Query|Text Query, Season, Episode, IMDb ID|Text Query, IMDb ID|Not Supported|Not Supported|
|[DanishBytes](https://danishbytes.club/){#danishbytes}|DanishBytes is a Private Danish Tracker|en-US|False|Text Query|Text Query, Season, Episode, IMDb ID, TVDb Id|Text Query, IMDb ID, TMDb Id|Text Query|Text Query|
|[ExoticaZ](https://exoticaz.to/){#exoticaz}|ExoticaZ (YourExotic) is a Private Torrent Tracker for 3X|en-US|False|Text Query|Not Supported|Text Query|Not Supported|Not Supported|
|[FileList](https://filelist.io){#filelist.io}|FileList (FL) is a ROMANIAN Private Torrent Tracker for 0DAY / GENERAL|en-US|False|Text Query|Text Query, Season, Episode|Text Query, IMDb ID|Text Query|Text Query|
|[GazelleGames](https://gazellegames.net/){#gazellegames}|GazelleGames (GGn) is a Private Torrent Tracker for GAMES|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[HDSpace](https://hd-space.org/){#hd-space}|HD-Space (HDS) is a Private Torrent Tracker for HD MOVIES / TV|en-US|False|Text Query|Text Query, Season, Episode, IMDb ID|Text Query, IMDb ID|Text Query|Not Supported|
|[HDTorrents](https://hdts.ru/){#hd-torrents}|HD-Torrents is a private torrent website with HD torrents and strict rules on their content.|en-US|False|Text Query|Text Query, Season, Episode, IMDb ID|Text Query, IMDb ID|Text Query|Not Supported|
|[HDBits](https://hdbits.org){#hdbits}|Best HD Tracker|en-US|False|Text Query|Text Query, Season, Episode, TVDb Id|Text Query, IMDb ID|Not Supported|Not Supported|
|[ImmortalSeed](https://immortalseed.me/){#immortalseed}|ImmortalSeed (iS) is a Private Torrent Tracker for MOVIES / TV / GENERAL|en-US|False|Text Query|Text Query, Season, Episode|Text Query|Text Query|Text Query|
|[IPTorrents](https://iptorrents.com/){#iptorrents}|IPTorrents (IPT) is a Private Torrent Tracker for 0DAY / GENERAL.|en-US|False|Text Query|Text Query, Season, Episode, IMDb ID|Text Query, IMDb ID|Text Query|Text Query|
|[LatTeam](https://lat-team.com/){#lat-team}|Lat-Team is a Private Torrent Tracker for HD MOVIES / TV|es|False|Text Query|Text Query, Season, Episode, IMDb ID, TVDb Id|Text Query, IMDb ID, TMDb Id|Text Query|Not Supported|
|[MoreThanTV](https://www.morethantv.me/){#morethantv}|Private torrent tracker for TV / MOVIES|en-US|False|Text Query|Text Query, Season, Episode|Text Query|Not Supported|Not Supported|
|[MyAnonamouse](https://www.myanonamouse.net/){#myanonamouse}|MyAnonaMouse (MAM) is a large ebook and audiobook tracker.|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Text Query|
|[Nebulance](https://nebulance.io/){#nebulance}|Nebulance (NBL) is a ratioless Private Torrent Tracker for TV|en-US|False|Text Query|Text Query, Season, Episode|Not Supported|Not Supported|Not Supported|
|[NorBits](https://norbits.net/){#norbits}|NorBits is a Norwegian Private site for MOVIES / TV / GENERAL|nb-NO|False|Text Query|Text Query, Season, Episode|Text Query, IMDb ID|Text Query|Text Query|
|[NotWhatCD](https://notwhat.cd/){#notwhat.cd}|NotWhat\.CD (NWCD) is a private Music tracker that arised after the former (WCD) shut down.|en-US|False|Text Query|Text Query, Season, Episode|Text Query|Text Query, Album, Artist, Label, Year|Text Query|
|[Orpheus](https://orpheus.network/){#orpheus}|Orpheus (APOLLO) is a Private Torrent Tracker for MUSIC|en-US|False|Text Query|Not Supported|Not Supported|Text Query, Album, Artist, Label, Year|Text Query|
|[PassThePopcorn](https://passthepopcorn.me){#passthepopcorn}|PassThePopcorn (PTP) is a Private site for MOVIES / TV|en-US|False|Text Query|Not Supported|Text Query, IMDb ID|Not Supported|Not Supported|
|[PornoLab](https://pornolab.net/){#pornolab}|PornoLab is a Semi-Private Russian site for Adult content|ru-ru|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[PreToMe](https://pretome.info/){#pretome}|PreToMe is a ratioless 0Day/General tracker.|en-US|False|Text Query|Text Query, Season, Episode, IMDb ID|Text Query, IMDb ID|Text Query|Text Query|
|[PrivateHD](https://privatehd.to/){#privatehd}|PrivateHD is a Private Torrent Tracker for HD MOVIES / TV and the sister-site of AvistaZ, CinemaZ, ExoticaZ, and AnimeTorrents|en-US|False|Text Query|Text Query, Season, Episode, IMDb ID, TVDb Id|Text Query, IMDb ID, TMDb Id|Text Query|Not Supported|
|[Redacted](https://redacted.ch/){#redacted}|REDActed (Aka\.PassTheHeadPhones) is one of the most well-known music trackers.|en-US|False|Text Query|Text Query, Season, Episode|Text Query|Text Query, Album, Artist, Label, Year|Text Query|
|[RevolutionTT](https://revolutiontt.me/){#revolutiontt}|The Revolution has begun|en-US|False|Text Query|Text Query, Season, Episode|Text Query, IMDb ID|Text Query|Text Query|
|[RuTracker](https://rutracker.org/){#rutracker}|RuTracker is a Semi-Private Russian torrent site with a thriving file-sharing community|ru-org|False|Text Query|Text Query, Season, Episode|Text Query|Text Query|Text Query|
|[SceneTime](https://www.scenetime.com/){#scenetime}|Always on time|en-US|False|Text Query|Text Query, Season, Episode|Text Query|Text Query|Text Query|
|[SecretCinema](https://secret-cinema.pw/){#secret-cinema}|A tracker for rare movies.|en-US|False|Text Query|Not Supported|Text Query, IMDb ID|Text Query, Album, Artist, Label, Year|Not Supported|
|[SpeedApp](https://speedapp.io){#speedapp.io}|SpeedApp is a ROMANIAN Private Torrent Tracker for MOVIES / TV / GENERAL|ro-RO|False|Text Query|Text Query, Season, Episode|Text Query, IMDb ID|Text Query|Text Query|
|[SpeedCD](https://speed.cd/){#speedcd}|Your home now!|en-US|False|Text Query|Text Query, Season, Episode, IMDb ID|Text Query, IMDb ID|Text Query|Text Query|
|[TorrentDay](https://torrentday.cool/){#torrentday}|TorrentDay (TD) is a Private site for TV / MOVIES / GENERAL|en-US|False|Text Query|Text Query, Season, Episode, IMDb ID|Text Query, IMDb ID|Text Query|Text Query|
|[TorrentSyndikat](https://torrent-syndikat.org/){#torrentsyndikat}|A German general tracker|de-DE|False|Text Query|Text Query, Season, Episode|Text Query, IMDb ID|Text Query|Text Query|
|AnimeTosho{#torznab}|A Newznab-like api for torrents.|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|HD4Free\.xyz{#torznab}|A Newznab-like api for torrents.|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|Generic Torznab{#torznab}|A Newznab-like api for torrents.|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Xthor](https://api.xthor.tk/){#xthor}|Xthor is a general Private torrent site|fr-FR|False|Text Query|Text Query, Season, Episode|Text Query, TMDb Id|Text Query|Text Query|
|[ZonaQ](https://www.zonaq.pw/){#zonaq}|ZonaQ is a SPANISH Private Torrent Tracker for MOVIES / TV|es-ES|False|Text Query|Text Query, Season, Episode|Text Query|Not Supported|Not Supported|
...
|Indexer|Description|Language|Supports Raw Search|Search Types|TV Search Types|Movie Search Types|Music Search Types|Book Search Types|
|:--|:--|:--|:--|:--|:--|:--|:--|:--|
|[BinSearch](https://binsearch.info/){#binsearch}|The binary Usenet search engine|en-US|False|Text Query|Text Query, Season, Episode|Text Query|Text Query|Text Query|

### Private & Semi-Private Indexers

|Indexer|Description|Language|Supports Raw Search|Search Types|TV Search Types|Movie Search Types|Music Search Types|Book Search Types|
|:--|:--|:--|:--|:--|:--|:--|:--|:--|
|[Headphones](https://indexer.codeshy.com){#headphones-vip}|A Private Usenet indexer for music|en-US|False|Text Query|Not Supported|Not Supported|Text Query|Not Supported|
|[abNZB](https://abnzb.com){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[altHUB](https://althub.co.za){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[AnimeTosho (Usenet)](https://animetosho.org){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[DOGnzb](https://dognzb.cr){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[DrunkenSlug](https://drunkenslug.com){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[GingaDADDY](https://www.gingadaddy.com){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Miatrix](https://www.miatrix.com){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Newz-Complex](https://newz-complex.org/www){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Newz69](https://newz69.keagaming.com){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[NinjaCentral](https://ninjacentral.co.za){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Nzb\.su](https://nzb.su){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[NZBCat](https://nzb.cat){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[NZBFinder](https://nzbfinder.ws){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[NZBgeek](https://nzbgeek.info){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[NzbNoob](https://www.nzbnoob.com){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[NZBNDX](https://www.nzbndx.com){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[NzbPlanet](https://nzbplanet.net){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[NZBStars](https://nzbstars.com){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[OZnzb](https://oznzb.com){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[SimplyNZBs](https://simplynzbs.com){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[SpotNZB](https://spotnzb.xyz){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Tabula Rasa](https://www.tabula-rasa.pw){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|[Usenet Crawler](https://www.usenet-crawler.com){#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
|Generic Newznab{#newznab}|Newznab is an API search specification for Usenet|en-US|False|Text Query|Not Supported|Not Supported|Not Supported|Not Supported|
