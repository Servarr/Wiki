...
- Path - The folder containing your book library i.e. the final destination as Readarr sees it.
   ...
   - If you are using docker and Calibre integration, the mounts must the same to your books folder.
...
- One of the best and simplest ways to utilize Torrent trackers with Readarr is to utilize a second program such as utilize a second program such as utilize a second program such as [Prowlarr](/prowlarr) or [Jackett](https://github.com/Jackett/Jackett). These software pair well with Readarr as a search indexer that houses all your information and sends it to Readarr.
