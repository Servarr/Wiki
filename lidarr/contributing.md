...
1. Open `src/Lidarr.sln`
2. Set `Lidarr.Console` as startup project (framework: `net6.0`)
3. Hit F5 to build and run
4. Backend available at `http://localhost:8686`

#### Command Line
```bash
# Build and run
dotnet run --project src/Lidarr.Console

# Or build for production
dotnet publish src/Lidarr.sln -c Release -o _output
```
