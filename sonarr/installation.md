...
- [Multiple Instances](#multiple-instances)
  - [Windows Multiple Instances](#windows-multiple-instances)
    ...
    - [Configuring Sonarr-4k](#configuring-sonarr-4k-windows-multi-config-second)
...
1. Enter the appropaite command(s) for your DSM version noted below and press enter
