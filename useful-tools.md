...
1. Save (or copy, if \*Arr is no the same system) the new database in the config folder and point the application at it. All \*Arrs name their database as `<appname>.db` e.g. `radarr.db`
