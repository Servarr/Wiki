...
You'll need curl, mediainfo, and sqlite. `sudo apt install curl
mediainfo sqlite3`
...
![Example of Radarr download options](ARR_Download_Link_Example.png
"Example of Radarr download options") In the example screenshot here,
you can see multiple options. Choose the option that matches your OS and
processor best. For most users, this would be `.linux-core-x64.tar.gz`
selected via `arch=x64` in the url.
...
![Move-sonarr-to-applications.gif](Move-sonarr-to-applications.gif
"Move-sonarr-to-applications.gif")

<li>

From there if you go to your launch pad you'll notice that Sonarr is now
in there, double click on Sonarr
...
![sonarr-developer-cannot-be-verified.png](sonarr-developer-cannot-be-verified.png
"sonarr-developer-cannot-be-verified.png")
...
![framless|250px](sonarr-developer-cannot-be-verified2.png
"framless|250px")
...
![sonarr-cannot-launch-sonarr-mono.png](sonarr-cannot-launch-sonarr-mono.png
"sonarr-cannot-launch-sonarr-mono.png")
...
Now browse to <http://localhost:8989>
...
Manual installs methods are unsupported and you'll need to determine the
process yourself.
...
You'll need curl, mediainfo, chromaprint, and sqlite. `sudo apt install
curl mediainfo sqlite3 libchromaprint-tools`

###### Manual Install

Note: this assumes you created a user named `lidarr`

![Example of Lidarr download options](ARR_Download_Link_Example.png
"Example of Lidarr download options") In the example screenshot here,
you can see multiple options. Choose the option that matches your OS and
processor best. For most users, this would be `.linux-core-x64.tar.gz`
selected via `arch=x64` in the url.
