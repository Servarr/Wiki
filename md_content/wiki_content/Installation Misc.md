...
![Example of Radarr download options](ARR_Download_Link_Example.png "Example of Radarr download options") In the example screenshot here, you can see multiple options. Choose the option that matches your OS and processor best. For most users, this would be `.linux-core-x64.tar.gz` selected via `arch=x64` in the url.
...
1.  After downloading Sonarr V3 from [here](https://services.sonarr.tv/v1/download/phantom-develop/latest?version=3&os=macos&installer=true). The `zip` file will be located in your downloads directory.
...
![Move-sonarr-to-applications.gif](Move-sonarr-to-applications.gif "Move-sonarr-to-applications.gif")
...
![sonarr-developer-cannot-be-verified.png](sonarr-developer-cannot-be-verified.png "sonarr-developer-cannot-be-verified.png")
...
![sonarr-cannot-launch-sonarr-mono.png](sonarr-cannot-launch-sonarr-mono.png "sonarr-cannot-launch-sonarr-mono.png")
...
1.  Click Download
2.  Safari (or default browser) will now open up to [the Mono Project](https://www.mono-project.com/download/stable/#download-mac) for macOS. Click **Download mono (Stable channel)**
...
![Example of Lidarr download options](ARR_Download_Link_Example.png "Example of Lidarr download options") In the example screenshot here, you can see multiple options. Choose the option that matches your OS and processor best. For most users, this would be `.linux-core-x64.tar.gz` selected via `arch=x64` in the url.
